package cosc426.program.sudoku2;
    ...
    public AppInterface(Context context, int width, int[][] values,
        ...
        for(int i  = 0; i < board.length; i++)
            for(int j = 0; j < board[0].length; j++){
                ...
                //line borders
                if((j+1)%3 == 0 && (i+1)%3 == 0){
                    params.topMargin = params.bottomMargin = 3;
                    params.leftMargin =  params.rightMargin = 3;
                }else {
